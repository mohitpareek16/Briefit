...
import { MapPin, ChevronDown, Phone, Zap, ArrowRight, ArrowLeft, Check } from "lucide-react";
...
const STEPS = ["Personal Info", "Skills & Location", "Final Details"];

export default function HustlerRegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] relative overflow-hidden">
      <div className="absolute -top-40 right-0 w-80 h-80 bg-purple-700/20 rounded-full blur-3xl" />
      ...
      <main className="relative z-10 flex items-center justify-center min-h-screen px-4 py-24">
        ...
        >
          ...
          <div className="text-center mb-8">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-purple-600 to-purple-400
              flex items-center justify-center mx-auto mb-4 neon-glow">
              <Zap className="w-7 h-7 text-white" />
            </div>
            <h1 className="text-3xl font-bold text-white mb-2">Join as a Hustler</h1>
            <p className="text-slate-400 text-sm">Get matched with founders who need your skills</p>
          </div>
              ...
              <div key={s} className="flex items-center flex-1">
                ...
                {i < STEPS.length - 1 && (
                  <div className={`flex-1 h-0.5 mx-2 transition-all duration-300 ${
                    i < step ? "bg-purple-600" : "bg-white/10"
                  }`} />
                )}
              </div>
            ))}

...
import { Zap, User, MapPin, Phone, Briefcase, ChevronRight, ChevronLeft, Rocket } from 'lucide-react'
import { createClient } from '@/lib/supabase/client'
import { HEARD_FROM } from '@/lib/types'
...
export default function EntrepreneurOnboarding() {
  ...
  useEffect(() => {
    ...
    supabase.auth.getUser().then(({ data }) => {
      if (!data.user) { router.push('/auth?role=entrepreneur'); return }
      setUser(data.user)
